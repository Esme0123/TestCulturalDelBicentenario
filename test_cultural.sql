...
(20, 'Pedro Domingo Murillo'),
(21, 'Proclamación de independencia'),
(22, 'Fundación de La Paz'),
(23, 'Firma de la primera constitución'),
(24, 'La Bandera Tricolor'),
(25, 'La Diablada'),
(26, 'El Sol de Pando'),
(27, '1825'),
(28, '1809'),
...
(41, 'La Morenada'),
(42, 'El Tinku'),
(43, 'Carnaval de Oruro'),
(44, 'Fiesta de la Virgen de Copacabana'),
(45, 'Fiesta de la Virgen de La Candelaria'),
(46, 'Verdadero'),
(47, 'Falso'),
(48, 'Verdadero'),
(49, 'Falso'),
...
(62, 'Sí'),
(63, 'No'),
(64, 'Antonio José de Sucre'),
(65, 'Simón Bolívar'),
(66, 'José Manuel Pando'),
(67, '1825'),
(68, '1830'),
(69, '1809'),
(70, 'Evo Morales'),
(71, 'Carlos Mesa'),
(72, 'Jaime Paz Zamora'),
(73, 'Ley de Voto Universal de 1952'),
(74, 'Ley de Reforma Agraria de 1953'),
(75, 'Ley de Nacionalización del Gas'),
(76, 'Hilarión Daza'),
(77, 'José Ballivián'),
(78, 'Andrés de Santa Cruz'),
(79, 'La Constitución de 1826'),
(80, 'El Tratado de Paz y Amistad con Chile'),
(81, 'La Carta Magna de 1831'),
(82, 'Víctor Paz Estenssoro'),
(83, 'Carlos Mesa'),
(84, 'Evo Morales'),
(85, '2006'),
(86, '2002'),
...
(143, '“El hermano”'),
(144, '“Raza de Bronce”'),
(145, '“Las voces del viento”'),
(146, 'Giovanna Rivero'),
(147, 'María José Lanza'),
(148, 'Ana María Ríos'),
(149, 'Marcos Villegas'),
(150, 'Guillermo Aillón'),
(151, 'Roberto Mamani'),
(152, 'Falso'),
(153, 'Verdadero'),
(154, 'Verdadero'),
...
(164, 'Boliviano'),
(165, 'Peso boliviano'),
(166, 'Dólar estadounidense'),
(167, '2006'),
(168, '2002'),
(169, '2010'),
(170, 'Fondo Monetario Internacional (FMI)'),
(171, 'Banco Mundial'),
(172, 'Banco Central de Bolivia'),
(173, 'Verdadero'),
(174, 'Falso'),
(175, 'Verdadero'),
(176, 'Falso'),
...
(180, 'Falso'),
(181, 'Banco Mundial'),
(182, 'Fondo Monetario Internacional (FMI)'),
(183, 'NASA'),
(184, 'Instituto Nacional de Ciencias de la Salud (INCS)'),
(185, 'Instituto Nacional de Innovación Agropecuaria y Forestal (INIAF)'),
(186, 'Centro de Investigación y Promoción del Campesinado (CIPCA)'),
(187, '1826'),
(188, '1830'),
(189, '1900'),
(190, 'China'),
...
(205, 'Simón Bolívar'),
(206, 'Carlos Mesa'),
(207, 'Hernán Siles Zuazo'),
(208, 'Sucre'),
(209, 'La Paz'),
(210, 'Cochabamba'),
(211, 'Aprobación de la nueva Constitución'),
(212, 'Firma del Tratado de Paz con Chile'),
(213, 'Fundación del Estado Plurinacional'),
(214, 'La bandera tricolor'),
(215, 'El sol de Pando'),
(216, 'La estrella roja'),
(217, 'Falso'),
(218, 'Verdadero'),
(219, 'Verdadero'),
(220, 'Falso'),
...
(2, 'Test Bicentenario Ni', 'Evaluación básica sobre la his', 2, 1, 1, 0, '2025-05-13', NULL),
(3, 'Test sobre la indepe', 'Test sobre los eventos y figur', 2, 1, 1, 0, '2025-05-13', NULL),
(4, 'Test sobre la cultur', 'Test sobre las danzas, festiva', 1, 3, 1, 0, '2025-05-13', NULL),
...
--
ALTER TABLE `lecturas_videos`
  MODIFY `id_lectura` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
ALTER TABLE `preguntas`
  MODIFY `id_pregunta` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
...
--
ALTER TABLE `respuestapreguntas`
  MODIFY `id_resPreg` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=186;

--
-- AUTO_INCREMENT de la tabla `respuestas`
--
ALTER TABLE `respuestas`
  MODIFY `id_respuesta` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=225;
...
--
ALTER TABLE `test_pregunta`
  MODIFY `id_test_pregunta` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
