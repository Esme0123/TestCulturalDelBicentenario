...
exports.getDetalleResultadoTest = async(req, res) => {
    ...
    const sql = `
        SELECT
            ...
            (SELECT GROUP_CONCAT(r_correct.texto SEPARATOR ' | ')
             FROM resultado_pregunta rp_correct
             JOIN respuestas r_correct ON rp_correct.id_respuesta = r_correct.id_respuesta
             WHERE rp_correct.id_pregunta = rp.id_pregunta AND rp_correct.es_correcta = 1
